...
coffee_table = {
    ...
    },
   {
    ...
    cup_bg_clr=0xBEBEBE,           cup_bg_alpha=1.0,
    cup_fg_clr=0xBEBEBE,           cup_fg_alpha=1.0,
    handle_length=40,              handle_circ=4,
    handle_fg_clr=0xBEBEBE,        handle_fg_alpha=0.0,
    graduation_radius=127,
    graduation_thickness=1,        graduation_mark_circ=0.5,
    graduation_mark_angle=3,
    graduation_fg_clr=0xBEBEBE,    graduation_fg_alpha=0.5,
    saucer_thickness=6,            thick_saucer_circ=11/12,    
    saucer_radius=135,             thin_saucer_circ=11/12,    
    saucer_fg_clr=0xBEBEBE,        saucer_fg_alpha=0.0, 
    saucer_mark_fg_clr=0xBEBEBE,   saucer_mark_fg_alpha=0.0,
    inner_saucer=true, 
    txt_weight=0,                  txt_size=8.0,
    txt_fg_clr=0xBEBEBE,           txt_fg_alpha=0.0,
    caption='',                    caption2='',
    },
    {
    ...
    cup_bg_clr=0xBEBEBE,           cup_bg_alpha=0.0,
    cup_fg_clr=0xBEBEBE,           cup_fg_alpha=0.0,
    ...
    handle_fg_clr=0xBEBEBE,        handle_fg_alpha=1.0,
    saucer_thickness=6,            thick_saucer_circ=11/12,
    saucer_radius=155,             thin_saucer_circ=11/12,    
    saucer_fg_clr=0xBEBEBE,        saucer_fg_alpha=0.3,
    saucer_mark_fg_clr=0xBEBEBE,   saucer_mark_fg_alpha=0.0,
    txt_weight=0,                  txt_size=8.0,
    txt_fg_clr=0xBEBEBE,           txt_fg_alpha=0.0,
    caption='',                    caption2='',
    ...
    cup_bg_clr=0xffffff,           cup_bg_alpha=0.0,
    cup_fg_clr=0xFFFFFF,      	   cup_fg_alpha=0.0,
    handle_fg_clr=0xA40810,        handle_fg_alpha=1.0,
    ...
    saucer_mark_fg_clr=0xA40810,   saucer_mark_fg_alpha=0.4,
    txt_weight=0,                  txt_size=8.0,
    txt_fg_clr=0xFFFFFF,           txt_fg_alpha=0.0,
    caption='',                    caption2='',
},
    ...
    xtxt=-15,			   ytxt= 0,
    txt_weight=0,                  txt_size=8.0,
    txt_fg_clr=0x06FF1C,           txt_fg_alpha=0.8,
